...
class HbsCustomer(Document):
	...
	def check_duplicate(self):
		...
		# 1. Check by Company Name (unique per company)
		if c_name:
			...
			if existing_name:
				...
				frappe.throw(msg, title=_("Duplicate Company Name Blocked"))
		...
		if c_gst:
			...
			if existing_gst:
				...
				frappe.throw(msg, title=_("Duplicate Customer GST Blocked"))
